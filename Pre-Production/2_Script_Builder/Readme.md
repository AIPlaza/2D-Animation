...
(Remember to refer to 2D-Animation/Formats/ and check each document according to the kind of Format from ten available
so you can get the context for adaptation)
